...
const ThemeToggle = () => {
  ...
  return (
    <div className="w-full flex justify-between items-end text-white py-4">
      <div className="font-bold text-xl">calc</div>
      <div className="flex space-x-3 items-end">
        <div className="text-[10px] pb-[2px]">THEME</div>
        <div className="flex flex-col ">
          <div className="w-full space-x-3 flex justify-between text-white text-[10px] mb-[2px] px-2 ">
            <div>1</div>
            <div>2</div>
            <div>3</div>
          </div>
